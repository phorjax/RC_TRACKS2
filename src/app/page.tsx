  ...
  return (
    <main className="bg-[#3B3B3B]">
      ...
      <section className="md:px-12 mx-14" id="tracks">
        <div>
          <h2 className="mb-5 mt-16 text-5xl text-amber-400">TRACKS</h2>
          <h1 className="text-5xl text-white">ELIGE EL MEJOR CARRO RC Y SUPERA LOS DESAFIOS QUE TE OFRECE RC TRACKS!</h1>
        </div>
        <div className="m-12 flex flex-wrap gap-10 items-center justify-center h-96">
          <div className="card w-1/4 shadow-xl relative bg-base-100 bg-[url('../../public/Bosque.png')]" id="card">
            <div className="card-header bg-black bg-opacity-50 pb-1 flex items-center justify-center">
              <h2 className="text-5xl text-white m-4">EL BOSQUE EN RUINAS</h2>
            </div>
          ...
          <div className="card w-1/4 bg-base-100 shadow-xl relative bg-[url('../../public/Volcan.png')]" id="card">
            <div className="card-header bg-black bg-opacity-50 pb-1 flex items-center justify-center">
              <h2 className="text-5xl text-white m-4">EL VOLCAN</h2>
            </div>
          ...
          <div className="card w-1/4 bg-base-100 shadow-xl bg-[url('../../public/LaMina.png')]" id="card">
            <div className="card-header bg-black bg-opacity-50 pb-1 flex items-center justify-center">
              <h2 className="text-5xl text-white m-4">LA MINA</h2>
            </div>
            <div className="card-body">
              <p></p>
              {/* <div className="card-actions justify-end">
        ...
        <div className="block">
          <div className="flex flex-wrap items-center justify-center">
            <div className=" w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-5/12">
              <div className="md:px-12 mx-14">
                <h2 className="mt-16 mb-5 text-5xl text-amber-400">LOCACIONES</h2>
                <p className="mb-16 text-white font-bold">
      ...
      <section className="dark:bg-gray-900" id="contactenos">
        <div className="container px-6 py-12 md:px-12 mx-14">
          <div>
            <h2 className="mt-16 mb-5 text-5xl text-amber-400">CONTACTENOS</h2>
